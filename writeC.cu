...
int main(int argc, char **argv)
{
	...
	// Page-locked memroy A B on host (write combining)
	cudaHostAlloc( (void**)&a, 1024*1024*sizeof(int), cudaHostAllocWriteCombined );
	cudaHostAlloc( (void**)&b, 1024*1024*sizeof(int), cudaHostAllocWriteCombined );
	cudaHostAlloc( (void**)&c, 1024*1024*sizeof(int), cudaHostAllocWriteCombined );
